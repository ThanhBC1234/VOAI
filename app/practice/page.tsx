  ...
  return (
    <main className="inner-page practice-page">
      <header className="page-hero compact">
        ...
        <p>Pyodide có trạng thái tải riêng; bộ đếm 8 giây chỉ bắt đầu khi runtime đã sẵn sàng. Mỗi lượt chạy dùng một Python namespace mới trong Web Worker, nhưng không cô lập mã thù địch. Test công khai giúp debug; kiểm tra mù chỉ giấu ca kiểm tra khỏi giao diện trước khi chạy — nội dung vẫn có thể đọc trong source/bundle phía client.</p>
      </header>
      <CodePractice />
    </main>
  );
