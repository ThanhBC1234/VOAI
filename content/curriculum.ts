...
export const WEEKLY_CURRICULUM: readonly WeekPlan[] = [
  ...
  defineWeek({
    ...
    lessons: [
      ...
      lesson("Algorithm selection", "Lập ma trận dữ liệu→thuật toán.", "Benchmark 4 thuật toán trên 5 datasets.", "Không chọn theo hình đẹp duy nhất."),
    ],
    lab: { title: "Clustering arena", product: "Bộ benchmark có stability và runtime.", acceptance: ["Ít nhất 4 thuật toán", "Có noise dataset", "Có bảng quyết định"] },
  ...
  defineWeek({
    ...
    objectives: ["Chuẩn hóa boxes", "Đọc precision/recall/mAP", "Fine-tune một detector nhỏ"],
    ...
    lab: { title: "Tiny object detector", product: "Fine-tune detector + visual predictions + mAP report.", acceptance: ["Box validation", "Không augment sai box", "Có latency và per-class AP"] },
  ...
  defineWeek({
    ...
    lessons: [
      ...
      lesson("Pretraining loop", "Train encoder nhỏ.", "Chạy pretrain có checkpoint.", "Theo dõi collapse metrics."),
      lesson("Linear probing", "Đo chất lượng representation công bằng.", "Freeze encoder và train head.", "So random/supervised/SSL."),
    ],
    lab: { title: "Label-scarce vision", product: "SSL pretrain + linear probe + label-efficiency curve.", acceptance: ["Encoder frozen khi probe", "Cùng split", "Có nhiều label budgets"] },
